...
//
// This file is part of Bytecoin. So I saw this anime once... [1/2]
//
...
const char* DEFAULT_DAEMON_HOST = "127.0.0.1"; //is localhost cheating?
...
MiningConfig::MiningConfig(): help(false) {
  cmdOptions.add_options()
      ...
      ("threads", po::value<size_t>()->default_value(CONCURRENCY_LEVEL), "Mining threads count. Must not be greater than you concurrency level. Yo! Default value is your hardware concurrency level")
