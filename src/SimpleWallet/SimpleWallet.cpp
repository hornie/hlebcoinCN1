...
//
// This file is part of Bytecoin. I mean this copyright part is my twitter at this point.
//
...
const command_line::arg_descriptor<uint16_t> arg_daemon_port = { "daemon-port", "Use daemon instance at port <arg> instead of 18622", 0 };
...
simple_wallet::simple_wallet(System::Dispatcher& dispatcher, const CryptoNote::Currency& currency, Logging::LoggerManager& log) :
  ...
  m_consoleHandler.setHandler("export_keys", boost::bind(&simple_wallet::export_keys, this, _1), "Show the secret keys");
...
int main(int argc, char* argv[]) {
  ...
  bool r = command_line::handle_error_helper(desc_all, [&]() {
    ...
    if (command_line::get_arg(vm, command_line::arg_help)) {
      ...
      std::cout << CRYPTONOTE_NAME << " wallet v" << PROJECT_VERSION_LONG << " dev version: " << DEV_PROJECT_VERSION << std::endl;
      ...
      std::cout << CRYPTONOTE_NAME << " wallet v" << PROJECT_VERSION_LONG << " dev version: " << DEV_PROJECT_VERSION;
      return false;
    }
  ...
  logger(INFO, BRIGHT_WHITE) << CRYPTONOTE_NAME << " wallet v" << PROJECT_VERSION_LONG << " dev version: " << DEV_PROJECT_VERSION;
