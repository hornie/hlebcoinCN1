...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 6072; //this is not like it was before
...
const unsigned EMISSION_SPEED_FACTOR                         = 20; // das a thicc number too
...
const char* const SEED_NODES[] = { "82.146.42.149:18522", "82.146.42.20:18522"};
